...
public class BuyNowApplicationService {
    ...
    public String buyNow(BuyNowInput input){
        ...
        Quantity quantity = new Quantity(input.getQuatity());
    ...
    private ShippingCostService.CalculationResult calculateShippingCost(ShippingInput shipping) {
        ...
        ZipCode destionation = new ZipCode(shipping.getAddress().getZipCode());

        return shippingCostService.calculate(new ShippingCostService.CalculationRequest(origin, destionation));
