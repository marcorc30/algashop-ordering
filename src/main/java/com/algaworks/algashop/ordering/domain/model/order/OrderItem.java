...
public class OrderItem {
    ...
    //apontar uma referencia para o pai
...
//        Money money = this.price().multiply(new Quantity(10));
        Money money = this.price().multiply(this.quantity());
        this.setTotalAmount(money);
    }
