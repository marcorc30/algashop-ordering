...
import com.algaworks.algashop.ordering.infrastructure.persistence.order.OrderPersistenceProvider;
...
class OrdersTest {
    ...
    public void deveSomarOsValoresDosPedidosPorCliente(){
        ...
        /*
        CORRIGIR ESSE TESTE -> O RESULTADO DEVE  SER 20 AO INVES DE 12420
         */
        Assertions.assertThat(orders.totalSouldForCustomer(customerId).value()).isEqualTo(new BigDecimal("12420.00"));
