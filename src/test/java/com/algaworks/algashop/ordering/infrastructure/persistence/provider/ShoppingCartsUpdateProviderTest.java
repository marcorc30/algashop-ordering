...
class ShoppingCartUpdateProviderTest {
    ...
    private CustomerPersistenceProvider customersPersistenceProvider;
    ...
    @Autowired
    public ShoppingCartUpdateProviderTest(ShoppingCartsPersistenceProvider persistenceProvider,
                                        CustomerPersistenceProvider customersPersistenceProvider,
    ...
    public void setup() {
        if (!customersPersistenceProvider.exists(CustomerTestDataBuilder.DEFAULT_CUSTOMER_ID)) {
            customersPersistenceProvider.add(
                    CustomerTestDataBuilder.existingdCustomer().build()
            );
        }
    }
